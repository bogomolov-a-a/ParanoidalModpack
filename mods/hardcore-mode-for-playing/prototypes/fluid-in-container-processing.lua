...
local function remove_from_basic_technology_fill_and_empty_recipe_names(
    ...
    tech_util.remove_recipe_effect_from_technology(basic_technology_name, recipe_name, mode)
    tech_util.remove_recipe_effect_from_technology(basic_technology_name, empty_recipe_name, mode)
end
...
local function hide_fill_and_empty_non_fuel_fluid_in_container_recipes(recipe_name, empty_recipe_name, mode)
    tech_util.hide_recipe(recipe_name, mode)
    tech_util.hide_recipe(empty_recipe_name, mode)
end
local function add_fill_and_empty_non_fuel_fluid_in_container_recipes(
    ...
    tech_util.add_recipe_effect_to_technology(target_technology_name, recipe_name, mode)
    tech_util.add_recipe_effect_to_technology(target_technology_name, empty_recipe_name, mode)
end
local function handle_one_recipe(recipe_name, basic_technology_name, mode)
    ...
    local all_technology_names_for_recipe_with_fuel_result = tech_util
        .get_all_technology_names_with_fuel_result_specified_in_another_recipe_by_name(recipe_name, mode)
    local technology_names_by_result_results =
        get_technology_names_for_ingredient_fuel_result_dont_contain_in_basic_technology_tree(
            all_technology_names_for_recipe_with_fuel_result, basic_technology_name,
            mode)
