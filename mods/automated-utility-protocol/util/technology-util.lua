...
TechUtil.add_prerequisites_to_technology = function(technology_candidate_name, prerequisites, mode)
    ...
    _table.each(
        ...
        function(prerequisite_name)
            ...
            if _table.contains(technology.prerequisites, prerequisite_name) then
                TechnologyTreeUtil.print_technology_tree(technology_candidate_name, mode)                
...
TechUtil.remove_prerequisites_from_technology = function(technology_candidate_name, prerequisites, mode)
    ...
    _table.each(
        prerequisites,
        function(prerequisite_name)
            _table.remove_item(technology.prerequisites, prerequisite_name)
