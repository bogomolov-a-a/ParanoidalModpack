...
local function add_prerequisites_to_technologies_in_regular_tree(mode)
    ...
    tech_util.add_prerequisites_to_technology("bio-nutrient-paste",{ "bio-temperate-farming-1", "bio-desert-farming-1", "bio-swamp-farming-1", "bio-wood-processing","chlorine-processing-1" }, mode)
    ...
    tech_util.add_prerequisites_to_technology("bio-processing-green",{"angels-steel-smelting-1"},mode)
end
