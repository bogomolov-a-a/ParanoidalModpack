...
local function add_prerequisites_to_technologies_in_regular_tree(mode)
    ...
    tech_util.add_prerequisites_to_technology("angels-alloys-smelting-2",{ "angels-invar-smelting-1", "angels-gunmetal-smelting-1",  },mode)
    ...
    tech_util.add_prerequisites_to_technology("angels-advanced-chemistry-4",{"titanium-processing"},mode)
end
