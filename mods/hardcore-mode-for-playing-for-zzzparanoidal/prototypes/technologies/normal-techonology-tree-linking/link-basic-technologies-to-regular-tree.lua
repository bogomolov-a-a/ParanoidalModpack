...
local function reset_basic_technology_prerequisites_to_regular_tree(mode)
    tech_util.reset_prerequisites_for_technology("factory-architecture-t1",{ "coal-stone-processing", "coal-ore-smelting", "automation-science-pack" }, mode)
    tech_util.reset_prerequisites_for_technology("basic-automation",{ "factory-architecture-t1", "automation-science-pack" }, mode)
    tech_util.reset_prerequisites_for_technology("stone-wall",{ "basic-automation", "military-0", "basic-metal-processing" }, mode)
    if mods["P-U-M-P-S"] then
        tech_util.reset_prerequisites_for_technology("water-pumpjack-1",{ "basic-automation", "basic-metal-processing", "angels-copper-smelting-1", "electricity","coal-ore-smelting" }, mode)
    end
    tech_util.reset_prerequisites_for_technology("basic-logistics", { "iron-storage", "basic-electronics" }, mode)
    tech_util.reset_prerequisites_for_technology("logistics-0",{ "coal-ore-smelting", "basic-wood-production", "basic-metal-processing", "automation-science-pack" }, mode)
    tech_util.reset_prerequisites_for_technology("armor-absorb-1", { "basic-automation" }, mode)
    tech_util.reset_prerequisites_for_technology("bi-dart-turret",{ "basic-automation", "basic-metal-processing", "basic-wood-production", "coal-ore-smelting","automation-science-pack" }, mode)
    tech_util.reset_prerequisites_for_technology("electricity", { "basic-automation", "electricity-0" }, mode)
    tech_util.reset_prerequisites_for_technology("angels-zinc-smelting-1",_table.deepcopy(Utils.get_moded_object("technology", "zinc-processing", mode).prerequisites), mode)
    --заменяем удалённые технологии
   tech_util.replace_all_occurs_prerequisite_to_another_in_active_technologies("k-angels-advanced-chemistry-5","angels-advanced-chemistry-3", mode)
   tech_util.replace_all_occurs_prerequisite_to_another_in_active_technologies("bio-fermentation", "bio-farm-1", mode) 
   tech_util.replace_all_occurs_prerequisite_to_another_in_active_technologies("zinc-processing","angels-brass-smelting-1", mode)
   tech_util.replace_all_occurs_prerequisite_to_another_in_active_technologies("nitrogen-processing","angels-nitrogen-processing-1", mode)    
...
local function add_prerequisites_to_technologies_in_regular_tree(mode)
    ...
    if settings.startup["bobs-military-simplify"].value == false then
        tech_util.add_prerequisites_to_technology("uranium-ammo",{ "Schall-sniper-rifle", "advanced-depleted-uranium-smelting-1", "Schall-tank-H-0", "Schall-tank-SH-0","w93-modular-turrets-lcannon", "w93-modular-turrets-hcannon" }, mode)
    end
    ...
    if settings.startup["hardcore-mode-for-playing-use-separated-technologies-for-every-resource"].value then
        tech_util.add_prerequisites_to_technology("coal-ore-crushing",{ "angels-ore1-detected-resource-technology", "angels-ore3-detected-resource-technology" }, mode)
    end
    if settings.startup["hardcore-mode-for-playing-use-separated-technologies-for-every-resource"].value then
        tech_util.add_prerequisites_to_technology("burner-ore-crushing",{ "angels-ore5-detected-resource-technology", "angels-ore6-detected-resource-technology" }, mode)
        tech_util.add_prerequisites_to_technology("angels-ore1-detected-resource-technology",{ "water-detected-resource-technology" }, mode)
        tech_util.add_prerequisites_to_technology("angels-ore3-detected-resource-technology",{ "water-detected-resource-technology" }, mode)
        tech_util.add_prerequisites_to_technology("angels-ore5-detected-resource-technology",{ "water-aggregate-states" }, mode)
        tech_util.add_prerequisites_to_technology("angels-ore6-detected-resource-technology",{ "water-aggregate-states" }, mode)
        tech_util.add_prerequisites_to_technology("angels-ore2-detected-resource-technology",{ "water-aggregate-states" }, mode)
        tech_util.add_prerequisites_to_technology("angels-ore4-detected-resource-technology",{ "water-aggregate-states" }, mode)
    end
    --конец под настройками
    --отдельные моды, которые могут быть выключены или добавлены в сборку
    if mods["P-U-M-P-S"] then
    ...
    if mods["UnrealisticReactors"] then
        tech_util.add_prerequisites_to_technology("thermonuclear-bomb",{ "productivity-module-6", "fusion-reactor-equipment-2" }, mode)
    end
    if mods["RampantMaintenance"] then
        tech_util.add_prerequisites_to_technology("rampant-maintenance-reduce-failure-3", { "chemical-science-pack" },mode)
        tech_util.add_prerequisites_to_technology("rampant-maintenance-reduce-failure-5", { "production-science-pack" },mode)
        tech_util.add_prerequisites_to_technology("rampant-maintenance-reduce-failure-7", { "utility-science-pack" },mode)
        tech_util.add_prerequisites_to_technology("rampant-maintenance-reduce-failure-9", { "space-science-pack" }, mode)
        tech_util.add_prerequisites_to_technology("rampant-maintenance-reduce-damage-3", { "chemical-science-pack" },mode)
        tech_util.add_prerequisites_to_technology("rampant-maintenance-reduce-damage-5", { "production-science-pack" },mode)
        ...
        tech_util.add_prerequisites_to_technology("rampant-maintenance-reduce-damage-failure-3",{ "chemical-science-pack" }, mode)
        tech_util.add_prerequisites_to_technology("rampant-maintenance-reduce-damage-failure-5",{ "production-science-pack" }, mode)
        tech_util.add_prerequisites_to_technology("rampant-maintenance-reduce-damage-failure-7",{ "utility-science-pack" }, mode)
        tech_util.add_prerequisites_to_technology("rampant-maintenance-reduce-damage-failure-9", { "space-science-pack" },mode)
        tech_util.add_prerequisites_to_technology("rampant-maintenance-reduce-downtime-3", { "chemical-science-pack" },mode)
        tech_util.add_prerequisites_to_technology("rampant-maintenance-reduce-downtime-5", { "production-science-pack" },mode)
        tech_util.add_prerequisites_to_technology("rampant-maintenance-reduce-downtime-7", { "utility-science-pack" },mode)
        tech_util.add_prerequisites_to_technology("rampant-maintenance-reduce-downtime-9", { "space-science-pack" }, mode)
        tech_util.add_prerequisites_to_technology("rampant-maintenance-reduce-checks-3", { "chemical-science-pack" },mode)
        tech_util.add_prerequisites_to_technology("rampant-maintenance-reduce-checks-5", { "production-science-pack" },mode)
        ...
        tech_util.add_prerequisites_to_technology("rampant-maintenance-reduce-energy-3", { "chemical-science-pack" },mode)
        tech_util.add_prerequisites_to_technology("rampant-maintenance-reduce-energy-5", { "production-science-pack" },mode)
        ...
        tech_util.add_prerequisites_to_technology("rampant-maintenance-reduce-tile-5", { "production-science-pack" },mode)
        ...
        tech_util.add_prerequisites_to_technology("rampant-maintenance-reduce-pollution-3", { "chemical-science-pack" },mode)
        tech_util.add_prerequisites_to_technology("rampant-maintenance-reduce-pollution-5", { "production-science-pack" },mode)
        tech_util.add_prerequisites_to_technology("rampant-maintenance-reduce-pollution-7", { "utility-science-pack" },mode)
        tech_util.add_prerequisites_to_technology("rampant-maintenance-reduce-pollution-9", { "space-science-pack" },mode)
    end
    if mods["Warheads"] then
        tech_util.add_prerequisites_to_technology("basic-atomic-weapons",{ "nuclear-fuel-reprocessing", "electric-energy-accumulators" }, mode)
        tech_util.add_prerequisites_to_technology("artillery-atomics", { "full-fission-atomics" }, mode)
        tech_util.add_prerequisites_to_technology("californium-weapons",{ "bob-shotgun-shells", "bob-bullets", "Schall-sniper-rifle" }, mode)
        tech_util.add_prerequisites_to_technology("fusion-weapons", { "space-science-pack" }, mode)
        tech_util.add_prerequisites_to_technology("thermobaric-weaponry",{ "angels-explosives-1", "tank", "bob-rocket", "rocket-control-unit", "land-mine", "Schall-tank-H-0","Schall-tank-SH-0", "artillery" }, mode)
    end
    --конец отдельные моды, которые могут быть выключены или добавлены в сборку
    --остальное    
    tech_util.add_prerequisites_to_technology("electronics", { "bi-tech-timber", "angels-solder-smelting-basic" }, mode)
    tech_util.add_prerequisites_to_technology("production-science-pack",{ "productivity-module", "effectivity-module", "speed-module" },mode)        
    tech_util.add_prerequisites_to_technology("atomic-bomb",{ "nuclear-fuel-reprocessing" },mode)
    tech_util.add_prerequisites_to_technology("electric-engine", { "steam-power","automation-2" }, mode)
    tech_util.add_prerequisites_to_technology("personal-roboport-equipment",{ "defender", "nanobots","concrete" }, mode)
    tech_util.add_prerequisites_to_technology("bet-tech", { "battery" }, mode)
    tech_util.add_prerequisites_to_technology("extremely-advanced-material-processing",{ "bob-robo-modular-4", "effect-transmission-3","vehicle-motor-equipment","bob-nuclear-power-2",--[["bob-electric-energy-accumulators-3",   "bob-solar-energy-3",]] }, mode)
    tech_util.add_prerequisites_to_technology("extremely-advanced-rocket-payloads", {  "space-telescope", },mode)
    ...
    tech_util.add_prerequisites_to_technology("orbital-autonomous-fabricators",{ "advanced-material-processing-4", "centrifuging-2" }, mode)
    tech_util.add_prerequisites_to_technology("ober-nuclear-processing",{ "phosphorus-processing-2" }, mode)                   
    ...
    tech_util.add_prerequisites_to_technology("tungsten-alloy-processing",{ "nitinol-processing"  }, mode)
    ...
    tech_util.add_prerequisites_to_technology("bob-power-armor-4", {  "space-telescope",  }, mode)
    tech_util.add_prerequisites_to_technology("bob-power-armor-5", {  "space-shuttle" }, mode)
    ...
    tech_util.add_prerequisites_to_technology("Ducts", {  "bob-fluid-handling-2","angels-titanium-smelting-1" }, mode)
    ...
    tech_util.add_prerequisites_to_technology("ore-crushing", {  "water-aggregate-states", }, mode)
    tech_util.add_prerequisites_to_technology("slag-processing-1", {  "bi-tech-ash", }, mode)
    tech_util.add_prerequisites_to_technology("advanced-ore-refining-2",{ "angels-metallurgy-3","electric-engine", }, mode)
    ...
    tech_util.add_prerequisites_to_technology("water-treatment-2",{  "bi-tech-coal-processing-1", }, mode)
    tech_util.add_prerequisites_to_technology("water-treatment-3", {  "angels-metallurgy-3" }, mode)
    tech_util.add_prerequisites_to_technology("water-treatment-4",{  "nuclear-fuel-reprocessing-2" }, mode)
    ...
    tech_util.add_prerequisites_to_technology("life-support-systems",{ "productivity-module-8", "advanced-osmium-smelting" }, mode)
    tech_util.add_prerequisites_to_technology("spaceship-command",{ "productivity-module-8", "advanced-osmium-smelting" }, mode)
    ...
    tech_util.add_prerequisites_to_technology("bob-boiler-3", { "angels-coal-cracking","Fuel-Additive" }, mode)
    tech_util.add_prerequisites_to_technology("angels-nitrogen-processing-2", { "bio-nutrient-paste" }, mode)
    tech_util.add_prerequisites_to_technology("angels-nitrogen-processing-4",{ "angels-copper-tungsten-smelting-1", "tungsten-alloy-processing" }, mode)
    tech_util.add_prerequisites_to_technology("chlorine-processing-2",{  "angels-advanced-chemistry-3" }, mode)
    ...
    tech_util.add_prerequisites_to_technology("angels-advanced-chemistry-2",{  "angels-nitrogen-processing-2" }, mode)
    ...
    tech_util.add_prerequisites_to_technology("rubbers", { "angels-advanced-chemistry-2","rubber" }, mode)
    tech_util.add_prerequisites_to_technology("rubber", { "chlorine-processing-2", "angels-coolant-1","strand-casting-3" }, mode)
    ...
    tech_util.add_prerequisites_to_technology("CW-air-filtering-6",{ "angels-copper-tungsten-smelting-1", "space-science-pack" }, mode)
    tech_util.add_prerequisites_to_technology("petroleum-generator",{ "bob-steam-engine-3", "angels-metallurgy-3", "flammables",  }, mode)    
    ...
    tech_util.add_prerequisites_to_technology("angels-steel-smelting-3",{ "angels-chrome-smelting-2" }, mode)
    ...
    tech_util.add_prerequisites_to_technology("angels-metallurgy-2", { "angels-stone-smelting-1", "ore-floatation" },mode)
    tech_util.add_prerequisites_to_technology("angels-metallurgy-4", {  "titanium-processing" },mode)
    tech_util.add_prerequisites_to_technology("angels-metallurgy-5", { "advanced-electronics-3" }, mode)
    tech_util.add_prerequisites_to_technology("ore-processing-5",{ "angels-tungsten-carbide-smelting-1" , "nitinol-processing" }, mode)
    tech_util.add_prerequisites_to_technology("angels-titanium-smelting-3", { "advanced-magnesium-smelting" }, mode)
    tech_util.add_prerequisites_to_technology("angels-tungsten-smelting-3",{  "sodium-processing-2","angels-manganese-smelting-3", "angels-zinc-smelting-2","phosphorus-processing-2", }, mode)
    ...
    tech_util.add_prerequisites_to_technology("angels-alloys-smelting-2",{ "angels-invar-smelting-1", "angels-gunmetal-smelting-1","angels-cobalt-steel-smelting-1","strand-casting-1"  },mode)
    tech_util.add_prerequisites_to_technology("angels-alloys-smelting-3",{  "angels-nitinol-smelting-1" }, mode)
    tech_util.add_prerequisites_to_technology("angels-ironworks-2",{ "angels-cobalt-steel-smelting-1", "angels-steel-smelting-2","powder-metallurgy-1" }, mode)
    tech_util.add_prerequisites_to_technology("powder-metallurgy-1",{ "angels-steel-smelting-1", "angels-stone-smelting-1" }, mode)
    ...
    tech_util.add_prerequisites_to_technology("bio-processing-paste",{ "angels-cobalt-smelting-1",  "angels-copper-smelting-2", "angels-gold-smelting-2",  "angels-iron-smelting-2","angels-titanium-smelting-2", "angels-tungsten-smelting-1", "angels-zinc-smelting-2" }, mode)
    tech_util.add_prerequisites_to_technology("bio-processing-alien-3", { "bio-processing-paste" }, mode)    
    tech_util.add_prerequisites_to_technology("bio-arboretum-1", { "bio-nutrient-paste", "bio-farm-2" },mode)
    tech_util.add_prerequisites_to_technology("bio-pressing-1", { "bio-temperate-farming-1","bio-swamp-farming-1", "bio-desert-farming-1", }, mode)
    tech_util.add_prerequisites_to_technology("bio-swamp-farming-1",{ "bio-temperate-farming-1", "bio-desert-farming-1" }, mode)
    tech_util.add_prerequisites_to_technology("bio-farm-2", { "concrete","bio-temperate-farming-1", "bio-desert-farming-1","bio-swamp-farming-1" }, mode)
    tech_util.add_prerequisites_to_technology("bio-temperate-farming-2",{ "angels-titanium-smelting-1", "advanced-electronics-2" }, mode)
    tech_util.add_prerequisites_to_technology("bio-desert-farming-2",{ "angels-titanium-smelting-1", "advanced-electronics-2" }, mode)
    tech_util.add_prerequisites_to_technology("bio-swamp-farming-2",{ "angels-titanium-smelting-1", "advanced-electronics-2" }, mode)
    tech_util.add_prerequisites_to_technology("bio-nutrient-paste",{ "bio-temperate-farming-1", "bio-desert-farming-1", "bio-swamp-farming-1", "bio-wood-processing","chlorine-processing-1", "angels-bronze-smelting-1"}, mode)
    tech_util.add_prerequisites_to_technology("bio-pressing-2",{ "angels-titanium-smelting-1", "advanced-electronics-2", "titanium-processing" }, mode)        
    ...
    tech_util.add_prerequisites_to_technology("bio-refugium-puffer-2",{ "bio-temperate-farming-2", "bio-desert-farming-2", "bio-swamp-farming-2" }, mode)
    tech_util.add_prerequisites_to_technology("bio-refugium-puffer-3",{ "angels-tungsten-smelting-1", "advanced-electronics-3", "tungsten-processing" }, mode)
    tech_util.add_prerequisites_to_technology("bio-refugium-biter-3",{ "bio-refugium-puffer-2", "angels-copper-tungsten-smelting-1", "tungsten-alloy-processing" }, mode)
    tech_util.add_prerequisites_to_technology("bio-processing-crystal-full",{ "production-science-pack", "ore-powderizer" }, mode)
    tech_util.add_prerequisites_to_technology("bio-refugium-biter-2",{ "angels-tungsten-smelting-1", "advanced-electronics-3", "tungsten-processing" }, mode)
    ...
    tech_util.add_prerequisites_to_technology("mercury-processing-1",{ "automation-science-pack", "logistic-science-pack", "chemical-science-pack" }, mode)
    tech_util.add_prerequisites_to_technology("centrifuging-2",{ "advanced-electronics-3", "angels-copper-tungsten-smelting-1", "utility-science-pack" }, mode)
    ...
    tech_util.add_prerequisites_to_technology("bio-farm-advanced-upgrade",{ "angels-tungsten-smelting-1", "advanced-electronics-3", "tungsten-processing" },mode)
    tech_util.add_prerequisites_to_technology("bio-refugium-hatchery-2",{ "angels-titanium-smelting-1", "advanced-electronics-3", "angels-tungsten-smelting-1" }, mode)
    tech_util.add_prerequisites_to_technology("water-washing-3", { "bob-drills-2" }, mode)
    tech_util.add_prerequisites_to_technology("bio-nutrient-paste-2",{"bio-temperate-farming-2","bio-desert-farming-2","bio-swamp-farming-2","titanium-processing"},mode)
    tech_util.add_prerequisites_to_technology("advanced-ore-refining-5",{ "angels-copper-tungsten-smelting-1", "tungsten-alloy-processing" }, mode)
    tech_util.add_prerequisites_to_technology("artillery-prototype", { "engine", "concrete", "military-science-pack" },mode)
    tech_util.add_prerequisites_to_technology("hiend_train", { "bob-railway-3",  "bet-charger-3" },mode)
    tech_util.add_prerequisites_to_technology("geode-crystallization-1", { "slag-processing-2" }, mode)
    tech_util.add_prerequisites_to_technology("angels-brass-smelting-1",{ "angels-zinc-smelting-1", "logistic-science-pack" }, mode)
    tech_util.add_prerequisites_to_technology("advanced-electronics", { "angels-brass-smelting-1" }, mode)
    tech_util.add_prerequisites_to_technology("angels-zinc-smelting-1", { "ore-floatation", "angels-lead-smelting-1","angels-metallurgy-2" },mode)                  
    ...
    tech_util.add_prerequisites_to_technology("advanced-ore-refining-2",{"concrete"},mode)
    ...
    tech_util.add_prerequisites_to_technology("remelting-alloy-mixer-4",{"advanced-electronics-2","titanium-processing","utility-science-pack"},mode)
    ...
    tech_util.add_prerequisites_to_technology("water-washing-4",{"advanced-electronics-2"},mode)
end
...
local function remove_prerequisites_from_technologies_in_regular_tree(mode)
    ...
    tech_util.remove_prerequisites_from_technology("rubber", { "rubbers" }, mode)
    tech_util.remove_prerequisites_from_technology("advanced-electronics-2",{"rubbers"},mode)
...
local function remove_recipes_from_technology_effects_in_regular_tree(mode)
   ...
   tech_util.remove_recipe_effect_from_technology("ober-nuclear-processing", "nuclear-smelting-copper-plate", mode)
    ...
    tech_util.remove_recipe_effect_from_technology("ober-nuclear-processing","nuclear-smelting-angels-solder-mixture-smelting", mode)
...
local function move_recipes_to_another_technologies(mode)
    ...
    tech_util.move_recipe_effects_to_another_technology("zinc-processing", "angels-brass-smelting-1","brass-pipe-to-ground", mode)
    tech_util.move_recipe_effects_to_another_technology("zinc-processing", "angels-brass-smelting-1", "brass-chest", mode)
    tech_util.move_recipe_effects_to_another_technology("zinc-processing", "angels-brass-smelting-1", "brass-gear-wheel",mode)    
    tech_util.move_recipe_effects_to_another_technology("k-angels-advanced-chemistry-5", "angels-advanced-chemistry-3","nitrous-oxide-synthesis-1", mode)
    tech_util.move_recipe_effects_to_another_technology("k-angels-advanced-chemistry-5", "angels-advanced-chemistry-3","nitrous-oxide-synthesis-2", mode)
    tech_util.move_recipe_effects_to_another_technology("k-angels-advanced-chemistry-5", "angels-advanced-chemistry-3","sodium-nitrate-synthesis", mode)
    tech_util.move_recipe_effects_to_another_technology("k-angels-advanced-chemistry-5", "angels-advanced-chemistry-3","acrylonitrile-synthesis", mode)
    tech_util.move_recipe_effects_to_another_technology("k-angels-advanced-chemistry-5", "angels-advanced-chemistry-3","catalyst-metal-cyan", mode)
    ...
    tech_util.move_recipe_effects_to_another_technology("tungsten-processing", "tungsten-alloy-processing","anotherworld-structure-components", mode)
    tech_util.move_recipe_effects_to_another_technology("basic-automation", "steam-power", "steam-inserter", mode)    
    tech_util.move_recipe_effects_to_another_technology("geode-processing-2", "geode-processing-3", "ober-liquify-ruby",mode)
    tech_util.move_recipe_effects_to_another_technology("geode-processing-2", "geode-processing-3","ober-liquify-sapphire", mode)
    tech_util.move_recipe_effects_to_another_technology("geode-processing-2", "geode-processing-3","ober-liquify-emerald", mode)
    tech_util.move_recipe_effects_to_another_technology("geode-processing-2", "geode-processing-3","ober-liquify-amethyst", mode)
    tech_util.move_recipe_effects_to_another_technology("geode-processing-2", "geode-processing-3", "ober-liquify-topaz",mode)
    tech_util.move_recipe_effects_to_another_technology("geode-processing-2", "geode-processing-3","ober-liquify-diamond", mode)
    tech_util.move_recipe_effects_to_another_technology("water-treatment", "water-treatment-2","bi-mineralized-sulfuric-waste", mode)
    tech_util.move_recipe_effects_to_another_technology("angels-advanced-chemistry-2", "angels-advanced-chemistry-3","acetylene-diomerisation", mode)
    ...
    tech_util.move_recipe_effects_to_another_technology("angels-sulfur-processing-1", "angels-sulfur-processing-2","condensator2", mode)
    tech_util.move_recipe_effects_to_another_technology("bio-processing-paste", "bio-nutrient-paste", "paste-cellulose",mode)
    tech_util.move_recipe_effects_to_another_technology("bio-farm-1", "bio-temperate-farming-1","temperate-garden-generation", mode)
    tech_util.move_recipe_effects_to_another_technology("bio-farm-1", "bio-swamp-farming-1", "swamp-garden-generation",mode)
    tech_util.move_recipe_effects_to_another_technology("bio-farm-1", "bio-swamp-farming-1", "desert-garden-generation",mode)
    tech_util.move_recipe_effects_to_another_technology("bio-nutrient-paste", "bio-nutrient-paste-2","solid-fruit-nutrients", mode)
    tech_util.move_recipe_effects_to_another_technology("angels-nitrogen-processing-2", "angels-nitrogen-processing-1","gas-ammonia", mode)
    tech_util.move_recipe_effects_to_another_technology("advanced-electronics", "alien-research", "sci-component-o", mode)
    if mods["aai-industry"] then 
        tech_util.move_recipe_effects_to_another_technology("phosphorus-processing-1", "phosphorus-processing-2", "solid-tetrasodium-pyrophosphate", mode)
    end
end
...
local function add_recipe_to_technology_effects(mode)
    ...
    -- дешёвый вариант плавки бронзы необходим, иначе нет достижимости производства бронзы, сразу в металлургию 1
