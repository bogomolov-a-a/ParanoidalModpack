...
powered_pump["water-pumpjack-1"].localised_description = { "", field_font_2, pumping_speed, end_font .. "30/s" }
powered_pump["water-pumpjack-2"].localised_description = { "", field_font_2, pumping_speed, end_font .. "60/s" }
powered_pump["water-pumpjack-3"].localised_description = { "", field_font_2, pumping_speed, end_font .. "90/s" }
powered_pump["water-pumpjack-4"].localised_description = { "", field_font_2, pumping_speed, end_font .. "120/s" }
powered_pump["water-pumpjack-5"].localised_description = { "", field_font_2, pumping_speed, end_font .. "150/s" }
