...
bobmods.lib.tech.remove_recipe_unlock("angels-copper-tungsten-smelting-1",
...
bobmods.lib.recipe.set_ingredients("seafloor-pump",
    { { "mining-drill-bit-mk1", 3 }, { "pipe", 25 }, { "basic-circuit-board", 10 }, { "iron-plate", 25 } })
bobmods.lib.recipe.set_ingredients("seafloor-pump-2",
    { { "mining-drill-bit-mk2", 3 }, { "steel-pipe", 30 }, { "electronic-circuit", 15 }, { "steel-plate", 30 }, { "seafloor-pump", 2 } })
bobmods.lib.recipe.set_ingredients("seafloor-pump-3",
    { { "mining-drill-bit-mk3", 3 }, { "titanium-pipe", 25 }, { "advanced-circuit", 15 }, { "titanium-plate", 25 }, { "seafloor-pump-2", 2 } })
...
--Разжижители
bobmods.lib.recipe.set_ingredients("liquifier",
    { { "iron-plate", 40 }, { "basic-circuit-board", 3 }, { "pipe", 40 }, { "stone-brick", 60 } })
bobmods.lib.recipe.set_ingredients("liquifier-2",
    { { "bronze-alloy", 40 }, { "electronic-circuit", 3 }, { "bronze-pipe", 40 }, { "clay-brick", 60 }, { "liquifier", 2 } })
bobmods.lib.recipe.set_ingredients("liquifier-3",
    { { "aluminium-plate", 40 }, { "advanced-circuit", 3 }, { "brass-pipe", 40 }, { "concrete", 60 }, { "liquifier-2", 2 } })
bobmods.lib.recipe.set_ingredients("liquifier-4",
    { { "titanium-plate", 40 }, { "processing-unit", 3 }, { "titanium-pipe", 40 }, { "refined-concrete", 60 }, { "liquifier-3", 2 } })
-- --Термальный экстрактор
bobmods.lib.recipe.set_ingredients("thermal-extractor",
    { { "aluminium-plate", 24 }, { "advanced-circuit", 5 }, { "brass-pipe", 12 }, { "concrete", 20 }, { "brass-gear-wheel", 12 }, { "intermediate-structure-components", 5 } })
-- --Хим заводы
...
bobmods.lib.recipe.set_ingredients("angels-chemical-plant-2",
    { { "bronze-alloy", 40 }, { "electronic-circuit", 3 }, { "bronze-pipe", 40 }, { "steel-gear-wheel", 25 }, { "angels-chemical-plant", 2 } })
bobmods.lib.recipe.set_ingredients("angels-chemical-plant-3",
    { { "aluminium-plate", 40 }, { "advanced-circuit", 3 }, { "brass-pipe", 40 }, { "brass-gear-wheel", 25 }, { "angels-chemical-plant-2", 2 } })
bobmods.lib.recipe.set_ingredients("angels-chemical-plant-4",
    { { "titanium-plate", 40 }, { "processing-unit", 3 }, { "titanium-pipe", 40 }, { "titanium-gear-wheel", 25 }, { "angels-chemical-plant-3", 2 } })
...
bobmods.lib.recipe.set_ingredients("boiler-5",
    { { "copper-tungsten-pipe", 15 }, { "boiler-4", 2 }, { "copper-tungsten-alloy", 20 } })
...
data.raw["recipe"]["bi-logs-3"].category =
"biofarm-mod-farm-2"                                                                        -- Прячем рецепты под новую ферму 2
data.raw["recipe"]["bi-logs-4"].category =
"biofarm-mod-farm-3"                                                                        -- Прячем рецепты под новую ферму 3
data.raw["recipe"]["bi-seed-3"].category =
"biofarm-mod-greenhouse-2"                                                                  -- Прячем рецепты под новую теплицу 2
data.raw["recipe"]["bi-seedling-3"].category =
"biofarm-mod-greenhouse-2"                                                                  -- Прячем рецепты под новую теплицу 2
data.raw["recipe"]["bi-seed-4"].category =
"biofarm-mod-greenhouse-3"                                                                  -- Прячем рецепты под новую теплицу 3
data.raw["recipe"]["bi-seedling-4"].category =
"biofarm-mod-greenhouse-3"                                                                  -- Прячем рецепты под новую теплицу 3
data.raw["assembling-machine"]["bi-bio-reactor"].energy_usage =
"200kW"                                                                                     --увеличиваем потребление биореактора мк 1
data.raw["assembling-machine"]["bi-bio-reactor"].module_specification.module_slots = 1      -- 1 слот модулей для мк1
bobmods.lib.recipe.set_ingredients("bi-bio-reactor",
    { { "assembling-machine-1", 2 }, { "steel-plate", 20 }, { "basic-circuit-board", 5 } }) --баланс рецепта биореактора 1
...
data.raw["recipe"]["bi-biomass-2"].category =
"biofarm-mod-bioreactor-2"                                                                  -- Прячем рецепты под новый биореактор 2
data.raw["recipe"]["bi-biomass-3"].category =
"biofarm-mod-bioreactor-3"                                                                  -- Прячем рецепты под новый биореактор 2
