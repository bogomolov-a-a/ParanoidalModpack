...
if settings.startup["fitolamps"].value then
	data.raw["assembling-machine"]["bi-bio-farm"].working_visualisations[1].animation.layers[1].tint =
		{ r = 230, g = 20, b = 190 }
	data.raw["assembling-machine"]["bi-bio-farm"].working_visualisations[1].animation.layers[1].hr_version.tint =
		{ r = 230, g = 20, b = 190 }

	data.raw["assembling-machine"]["bi-bio-greenhouse"].working_visualisations[1].animation.layers[1].tint =
		{ r = 230, g = 130, b = 210 }
	data.raw["assembling-machine"]["bi-bio-greenhouse"].working_visualisations[1].animation.layers[1].hr_version.tint =
		{ r = 230, g = 130, b = 210 }
end
--###############################################################################################
...
data.raw.tool["advanced-logistic-science-pack"].icons =
