...
local offshore_pump_types = { "offshore-mk0-pump", "offshore-pump", "offshore-mk2-pump", "offshore-mk3-pump",
    "offshore-mk4-pump", "seafloor-pump", "seafloor-pump-2", "seafloor-pump-3" }
--###############################################################################################
    ...
    player.force.add_chart_tag(player.surface,
        {
            ...
            text = 'Corpse: ' ..
                player.name ..
                '; Time: ' .. math.floor(game.tick / 60 / 60 / 60) .. ':' .. (math.floor(game.tick / 60 / 60) % 60),
