[![Запускаемость сборки](https://github.com/bogomolov-a-a/ParanoidalModpack/actions/workflows/launchability.yml/badge.svg?event=check_run)](https://github.com/bogomolov-a-a/ParanoidalModpack/actions/workflows/launchability.yml)
